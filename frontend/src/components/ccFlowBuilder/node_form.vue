                        ...
                        <div class="row q-mt-sm">
                          <div class="col">
                            ...
                            <q-input
                              ...
                              label="Mensagem enviar para cliente"
                              type="textarea"
                              autogrow
                              dense
                              outlined
                            ...
                            <!-- Condição para selecionar o usuário -->
                            <q-select
                            ...
                            <q-input
                              ...
                              @input="condition.nextStepId = null; condition.queueId = null; condition.closeTicket = null"
                            />
                            <!-- Condição para inserir a mensagem de encerramento -->
                            <q-input
