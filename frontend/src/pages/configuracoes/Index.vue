  ...
  <div class="mass-container container-rounded-10" :class="$q.dark.isActive ? 'text-green bg-grey-10' : 'container-border'" v-if="userProfile === 'admin'">
    <q-list class="text-weight-medium">
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Reabrir tickets anteriores ao receber novas mensagens</q-item-label>
...
<q-item-label caption>Caso o atendendete demorar a responder o contato o ticket vai voltar automaticamente para os Tickets pedentes.</q-item-label>
      ...
      <q-item tag="label" v-ripple>
        <q-item-section>
          <q-item-label>Quantidades de tickets abertos\pendentes será carregado na tela de atendimento.</q-item-label>
